...
class PdsFhir:
    r"""Personal Demographics Service (FHIR) API: ## Overview
    ...
    * 500 to 599 if it failed because of an error on our server
    ...
    def get_patient(self, request: operations.GetPatientRequest) -> operations.GetPatientResponse:
        r"""Get patient details
        ## Overview
        ...
        res = operations.GetPatientResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetPatient200ApplicationFhirPlusJSON])
                res.get_patient_200_application_fhir_plus_json_object = out
        elif http_res.status_code >= 400 and http_res.status_code < 500:
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetPatient4XXApplicationFhirPlusJSON])
                res.get_patient_4_xx_application_fhir_plus_json_object = out

        return res

    
    def get_related_people(self, request: operations.GetRelatedPeopleRequest) -> operations.GetRelatedPeopleResponse:
        r"""Get a patient's related people
        ## Overview
        ...
        res = operations.GetRelatedPeopleResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetRelatedPeople200ApplicationFhirPlusJSON])
                res.get_related_people_200_application_fhir_plus_json_object = out
        elif http_res.status_code >= 400 and http_res.status_code < 500:
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetRelatedPeople4XXApplicationFhirPlusJSON])
                res.get_related_people_4_xx_application_fhir_plus_json_object = out

        return res

    
    def search_patient(self, request: operations.SearchPatientRequest) -> operations.SearchPatientResponse:
        r"""Search for a patient
        ## Overview
        ...
        * it is almost certainly a good idea to display search results in descending score order - best match first
        ...
        https://fhir.nhs.uk/Id/ods-organization-code - ODS codes and documentation.
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.SearchPatientResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SearchPatient200ApplicationFhirPlusJSON])
                res.search_patient_200_application_fhir_plus_json_object = out
        elif http_res.status_code >= 400 and http_res.status_code < 500:
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SearchPatient4XXApplicationFhirPlusJSON])
                res.search_patient_4_xx_application_fhir_plus_json_object = out

        return res

    
    def update_patient_partial(self, request: operations.UpdatePatientPartialRequest) -> operations.UpdatePatientPartialResponse:
        r"""Update patient details
        ## Overview
        ...
        * You can use the patient with minimal data, `9000000033` to test adding all data types (as most of them are missing on this patient), that would normally be present (e.g. gender).
        ...
        [![Run in Postman](https://run.pstmn.io/button.svg)](https://app.getpostman.com/run-collection/14719036-953f067f-30b9-4552-8252-7cc10b21dad3)
        https://tools.ietf.org/html/rfc6902 - IETF RFC 6902, which defines json-patch.
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(operations.UpdatePatientPartialRequest, base_url, '/Patient/{id}', request)
        headers = utils.get_headers(request)
        ...
        res = operations.UpdatePatientPartialResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdatePatientPartial200ApplicationFhirPlusJSON])
                res.update_patient_partial_200_application_fhir_plus_json_object = out
        elif http_res.status_code >= 400 and http_res.status_code < 500:
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdatePatientPartial4XXApplicationFhirPlusJSON])
                res.update_patient_partial_4_xx_application_fhir_plus_json_object = out
        elif http_res.status_code == 503:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/fhir+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdatePatientPartial503ApplicationFhirPlusJSON])
                res.update_patient_partial_503_application_fhir_plus_json_object = out
