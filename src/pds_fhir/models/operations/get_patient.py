...
class GetPatient4XXApplicationFhirPlusJSONIssue:
    ...
    r"""Severity of the error."""
    details: Optional[GetPatient4XXApplicationFhirPlusJSONIssueDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('details'), 'exclude': lambda f: f is None }})
    r"""Internal error code."""
...
class GetPatient200ApplicationFhirPlusJSONAddressUse(str, Enum):
...
class GetPatient200ApplicationFhirPlusJSONAddress:
    ...
    r"""Purpose of this address:
      ...
      * if there is no valid, current `billing` and/or `temp` address, the `home` address must be used.
    """
    extension: Optional[list[GetPatient200ApplicationFhirPlusJSONAddressExtension]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extension'), 'exclude': lambda f: f is None }})
    ...
    *	line 5 - county (if present), e.g. `West Yorkshire`
    ...
    """
    period: Optional[GetPatient200ApplicationFhirPlusJSONAddressPeriod] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('period'), 'exclude': lambda f: f is None }})
    r"""Business effective period when name was, is, or will be in use."""
    postal_code: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('postalCode'), 'exclude': lambda f: f is None }})
    r"""Postal code of the address."""
    text: Optional[GetPatient200ApplicationFhirPlusJSONAddressText] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('text'), 'exclude': lambda f: f is None }})
    r"""Where a `temp` address is provided a descriptor text must be sent.
    The list of possible values are:
    * `Second Home` - a patient's second home
    * `Student Accommodation` - a patient's place of residence while at university
...
class GetPatient200ApplicationFhirPlusJSONSchemaForAPatientContactTelecomUse(str, Enum):
...
class GetPatient200ApplicationFhirPlusJSONSchemaForAPatientContactTelecom:
    ...
    extension: Optional[list[GetPatient200ApplicationFhirPlusJSONSchemaForAPatientContactTelecomExtension]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extension'), 'exclude': lambda f: f is None }})
    ...
    period: Optional[GetPatient200ApplicationFhirPlusJSONSchemaForAPatientContactTelecomPeriod] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('period'), 'exclude': lambda f: f is None }})
    r"""Business effective period when name was, is, or will be in use."""
    use: Optional[GetPatient200ApplicationFhirPlusJSONSchemaForAPatientContactTelecomUse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('use'), 'exclude': lambda f: f is None }})
    r"""Location associated with communication system."""
...
class GetPatient200ApplicationFhirPlusJSONSchemaForAPatientContact:
    ...
    """
    telecom: list[GetPatient200ApplicationFhirPlusJSONSchemaForAPatientContactTelecom] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('telecom') }})
...
class GetPatient200ApplicationFhirPlusJSONExtension8Extension1ValueCodeableConceptCodingCode(str, Enum):
...
class GetPatient200ApplicationFhirPlusJSONExtension6Extension2ValueCodeableConceptCodingSystem(str, Enum):
...
class GetPatient200ApplicationFhirPlusJSONExtension6Extension2ValueCodeableConceptCoding:
    ...
    * 8	- No Telephone contact
    ...
    system: Optional[GetPatient200ApplicationFhirPlusJSONExtension6Extension2ValueCodeableConceptCodingSystem] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('system'), 'exclude': lambda f: f is None }})
    r"""Definition of the preferred contact method extension."""
...
class GetPatient200ApplicationFhirPlusJSONExtension6Extension1ValueCodeableConceptCoding:
    ...
    * 13 - Audio tape
    ...
    system: Optional[GetPatient200ApplicationFhirPlusJSONExtension6Extension1ValueCodeableConceptCodingSystem] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('system'), 'exclude': lambda f: f is None }})
    r"""Definition of the preferred written communication extension."""
...
class GetPatient200ApplicationFhirPlusJSONExtension4Extension1ValueCodeableConceptCodingCode(str, Enum):
    r"""Symbol, in syntax, defined by the system:
...
class GetPatient200ApplicationFhirPlusJSONExtension4Extension1ValueCodeableConceptCodingDisplay(str, Enum):
    r"""Representation defined by the system."""
...
class GetPatient200ApplicationFhirPlusJSONExtension4Extension1ValueCodeableConceptCoding:
    ...
    * `U` - Removed. This is a possible response, but it cannot be used on an update because Spine will reject it
    ...
    system: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('system') }})
    r"""URI of the coding system specification."""
    display: Optional[GetPatient200ApplicationFhirPlusJSONExtension4Extension1ValueCodeableConceptCodingDisplay] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('display'), 'exclude': lambda f: f is None }})
    r"""Representation defined by the system."""
    version: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('version'), 'exclude': lambda f: f is None }})
    r"""Version of the coding system in use."""
...
class GetPatient200ApplicationFhirPlusJSONMetaSecurityDisplay(str, Enum):
    r"""Representation defined by the system."""
...
class GetPatient200ApplicationFhirPlusJSONName:
    ...
    * anonymous - Anonymous assigned name, alias, or pseudonym (used to protect a person's identity for privacy reasons).
    ...
    period: Optional[GetPatient200ApplicationFhirPlusJSONNamePeriod] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('period'), 'exclude': lambda f: f is None }})
    r"""Business effective period when name was, is, or will be in use."""
...
class GetPatient200ApplicationFhirPlusJSONTelecomUse(str, Enum):
    r"""Location associated with communication system."""
    HOME = 'home'
    WORK = 'work'
    TEMP = 'temp'
...
class GetPatient200ApplicationFhirPlusJSONTelecom:
    ...
    value: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})
    r"""Phone number, email address, or other identifier for use with contact system."""
    extension: Optional[list[GetPatient200ApplicationFhirPlusJSONTelecomExtension]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extension'), 'exclude': lambda f: f is None }})
    r"""Extension that is returned when the communication type is `textphone`. The only code returned is `textphone`, which means `Minicom (Textphone)`.
    ...
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is None }})
    r"""Unique object identifier for this contact point."""
    period: Optional[GetPatient200ApplicationFhirPlusJSONTelecomPeriod] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('period'), 'exclude': lambda f: f is None }})
    r"""Business effective period when name was, is, or will be in use."""
    use: Optional[GetPatient200ApplicationFhirPlusJSONTelecomUse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('use'), 'exclude': lambda f: f is None }})
    r"""Location associated with communication system."""
...
class GetPatient200ApplicationFhirPlusJSON:
    ...
    """
    contact: Optional[list[GetPatient200ApplicationFhirPlusJSONSchemaForAPatientContact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contact'), 'exclude': lambda f: f is None }})
    ...
    """
    gender: Optional[GetPatient200ApplicationFhirPlusJSONGender] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gender'), 'exclude': lambda f: f is None }})
    r"""Classification of the gender of a patient. The classification is phenotypical rather than genotypical, i.e. it does not provide codes for medical or scientific purposes.
    It is the administrative gender that the patient wishes to be known as. In some cases, this may not be the same as the patient’s registered birth gender, or their current clinical gender.
    """
    general_practitioner: Optional[list[GetPatient200ApplicationFhirPlusJSONGeneralPractitioner]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('generalPractitioner'), 'exclude': lambda f: f is None }})
    ...
    """
    identifier: Optional[list[GetPatient200ApplicationFhirPlusJSONIdentifier]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('identifier'), 'exclude': lambda f: f is None }})
    r"""Identifier and system of identification used for this Patient."""
    managing_organization: Optional[GetPatient200ApplicationFhirPlusJSONManagingOrganization] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('managingOrganization'), 'exclude': lambda f: f is None }})
    r"""The managing organization of a de-registered patient. This will not be returned when the reason for de-registration is death."""
    meta: Optional[GetPatient200ApplicationFhirPlusJSONMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})
    r"""Metadata about this resource."""
    ...
    """
    name: Optional[list[GetPatient200ApplicationFhirPlusJSONName]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    ...
    resource_type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceType'), 'exclude': lambda f: f is None }})
    r"""FHIR resource type."""
    telecom: Optional[list[GetPatient200ApplicationFhirPlusJSONTelecom]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('telecom'), 'exclude': lambda f: f is None }})
...
class GetPatientResponse:
    ...
    r"""Information successfully returned."""
    get_patient_4_xx_application_fhir_plus_json_object: Optional[GetPatient4XXApplicationFhirPlusJSON] = dataclasses.field(default=None)
